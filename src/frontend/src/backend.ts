...
import type { ApplicantDetails as _ApplicantDetails, ApplicationStatusResponse as _ApplicationStatusResponse, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async clearDocuments(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearDocuments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllApplications(): Promise<Array<ApplicantDetails>> {
        if (this.processError) {
            try {
    ...
    async getApplicationByUser(arg0: Principal): Promise<ApplicationStatusResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getApplicationByUser(arg0);
                return from_candid_ApplicationStatusResponse_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getApplicationStatus(): Promise<ApplicationStatusResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getApplicationStatus();
                return from_candid_ApplicationStatusResponse_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitApplicantDetails(arg0: ApplicantDetails): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitApplicantDetails(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadApplicationDocuments(arg0: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadApplicationDocuments(await to_candid_vec_n23(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ApplicationStatusResponse_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ApplicationStatusResponse): Promise<ApplicationStatusResponse> {
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ApplicantDetails]): ApplicantDetails | null {
...
async function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        documents: await from_candid_vec_n12(_uploadFile, _downloadFile, value.documents),
        applicantDetails: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.applicantDetails))
    };
}
